...
Date : 2019.07.30
Title: Simple TKinter Class 16-02
From Simple TKinter Class 05-03
Create a key binding for the listbox when any key is pressed let it call its own function
The function should check if up or down is pressed
Create a key binding for the entry when any key is pressed let it call its own function
The function should check if return is pressed
'''
...
class my_gui:
	def __init__(self, master):
		...
		self.my_listbox1.bind("<Key>", self.key_ml1_pressed)
		...
		self.my_entry1.bind("<Key>", self.key_me1_pressed)
