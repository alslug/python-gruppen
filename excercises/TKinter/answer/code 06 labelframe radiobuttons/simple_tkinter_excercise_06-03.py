...
Date : 2019.07.30
Title: Simple TKinter Class 06-03
...
class my_gui:
	def __init__(self, master):
		...
		for i in range(len(self.my_text)):
			self.my_rb1 = Radiobutton(group, text=self.my_text[i], variable=self.my_int1, value=i, command=self.my_click1)
			self.my_rb1.grid(row=1+i, column=0, sticky=W)
